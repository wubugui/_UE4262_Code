...
class FStylizedSkyVS : public FGlobalShader
{
	DECLARE_SHADER_TYPE(FStylizedSkyVS, Global);
public:
	...
	FStylizedSkyVS() { }
	FStylizedSkyVS(const ShaderMetaType::CompiledShaderInitializerType& Initializer) :
		FGlobalShader(Initializer)
	{
	}
...
IMPLEMENT_SHADER_TYPE(, FStylizedSkyVS, TEXT("/Engine/Private/Second/StylizedSkyShader.usf"), TEXT("VSMain"), SF_Vertex);

class FStylizedSkyPS : public FGlobalShader
{
	DECLARE_SHADER_TYPE(FStylizedSkyPS, Global);
	static bool ShouldCompilePermutation(const FGlobalShaderPermutationParameters& Parameters)
	{
		return IsFeatureLevelSupported(Parameters.Platform, ERHIFeatureLevel::SM5);
	}
	FStylizedSkyPS() {}
	//SHADER_USE_PARAMETER_STRUCT(FStylizedSkyPS, FGlobalShader);
public:
	LAYOUT_FIELD(FShaderParameter, _HorizonLineSunsetColor3_ToSunsetFalloff1);
	LAYOUT_FIELD(FShaderParameter, _ToNightSpeed1_HorizonLineColor3);
	LAYOUT_FIELD(FShaderParameter, _HorizonLineContribution1_SkyNightGradient3);
	LAYOUT_FIELD(FShaderParameter, _SkyGradientTop3_HorizonLineExponent1);
	LAYOUT_FIELD(FShaderParameter, _SkyGradientBottomhalf3_SkyGradientExponent1);
	LAYOUT_FIELD(FShaderParameter, _NightBtColor_Padding1);
	
	struct StyleParam
	{
		FVector4 _HorizonLineSunsetColor3_ToSunsetFalloff1;
		FVector4 _ToNightSpeed1_HorizonLineColor3;
		FVector4 _HorizonLineContribution1_SkyNightGradient3;
		FVector4 _SkyGradientTop3_HorizonLineExponent1;
		FVector4 _SkyGradientBottomhalf3_SkyGradientExponent1;
		FVector4 _NightBtColor_Padding1;
	};
	/* Initialization constructor. */
	FStylizedSkyPS(const ShaderMetaType::CompiledShaderInitializerType& Initializer)
		: FGlobalShader(Initializer)
	{
		_HorizonLineSunsetColor3_ToSunsetFalloff1.Bind(Initializer.ParameterMap, TEXT("_HorizonLineSunsetColor3_ToSunsetFalloff1"));
		_ToNightSpeed1_HorizonLineColor3.Bind(Initializer.ParameterMap, TEXT("_ToNightSpeed1_HorizonLineColor3"));
		_HorizonLineContribution1_SkyNightGradient3.Bind(Initializer.ParameterMap, TEXT("_HorizonLineContribution1_SkyNightGradient3"));
		_SkyGradientTop3_HorizonLineExponent1.Bind(Initializer.ParameterMap, TEXT("_SkyGradientTop3_HorizonLineExponent1"));
		_SkyGradientBottomhalf3_SkyGradientExponent1.Bind(Initializer.ParameterMap, TEXT("_SkyGradientBottomhalf3_SkyGradientExponent1"));
		_NightBtColor_Padding1.Bind(Initializer.ParameterMap, TEXT("_NightBtColor_Padding1"));
	}

	void SetParameters(FRHICommandList& RHICmdList, const FViewInfo& View, const StyleParam& param)
	{
		FGlobalShader::SetParameters<FViewUniformShaderParameters>(RHICmdList, RHICmdList.GetBoundPixelShader(), View.ViewUniformBuffer);
		
		SetShaderValue(RHICmdList, RHICmdList.GetBoundPixelShader(), _HorizonLineSunsetColor3_ToSunsetFalloff1, param._HorizonLineSunsetColor3_ToSunsetFalloff1);
		SetShaderValue(RHICmdList, RHICmdList.GetBoundPixelShader(), _ToNightSpeed1_HorizonLineColor3, param._ToNightSpeed1_HorizonLineColor3);
		SetShaderValue(RHICmdList, RHICmdList.GetBoundPixelShader(), _HorizonLineContribution1_SkyNightGradient3, param._HorizonLineContribution1_SkyNightGradient3);
		SetShaderValue(RHICmdList, RHICmdList.GetBoundPixelShader(), _SkyGradientTop3_HorizonLineExponent1, param._SkyGradientTop3_HorizonLineExponent1);
		SetShaderValue(RHICmdList, RHICmdList.GetBoundPixelShader(), _SkyGradientBottomhalf3_SkyGradientExponent1, param._SkyGradientBottomhalf3_SkyGradientExponent1);
		SetShaderValue(RHICmdList, RHICmdList.GetBoundPixelShader(), _NightBtColor_Padding1, param._NightBtColor_Padding1);
...
private:
	...
	BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
		SHADER_PARAMETER_EX(FVector4, _HorizonLineSunsetColor3_ToSunsetFalloff1, EShaderPrecisionModifier::Half)
		SHADER_PARAMETER_EX(FVector4, _ToNightSpeed1_HorizonLineColor3, EShaderPrecisionModifier::Half)
		SHADER_PARAMETER_EX(FVector4, _HorizonLineContribution1_SkyNightGradient3, EShaderPrecisionModifier::Half)
		SHADER_PARAMETER_EX(FVector4, _SkyGradientTop3_HorizonLineExponent1, EShaderPrecisionModifier::Half)
		SHADER_PARAMETER_EX(FVector4, _SkyGradientBottomhalf3_SkyGradientExponent1, EShaderPrecisionModifier::Half)
		SHADER_PARAMETER_EX(FVector4, _NightBtColor_Padding1, EShaderPrecisionModifier::Half)
	END_SHADER_PARAMETER_STRUCT()
#endif

};

IMPLEMENT_SHADER_TYPE(, FStylizedSkyPS, TEXT("/Engine/Private/Second/StylizedSkyShader.usf"), TEXT("StylizedSkyPSMain"), SF_Pixel);


// 渲染自定义天空
void SetStylizedSkyShaders(FRHICommandList& RHICmdList, FGraphicsPipelineStateInitializer& GraphicsPSOInit, const FViewInfo& View, 
	const FStylizedSkyPS::StyleParam& param)
{
	auto ShaderMap = View.ShaderMap;

	TShaderMapRef<FStylizedSkyVS> VertexShader(ShaderMap);
	TShaderRef<FStylizedSkyPS> PixelShader = TShaderMapRef<FStylizedSkyPS>(ShaderMap);
	...
	SetGraphicsPipelineState(RHICmdList, GraphicsPSOInit);
	VertexShader->SetParameters(RHICmdList, View);
	PixelShader->SetParameters(RHICmdList, View, param);
...
void FMobileSceneRenderer::RenderAtmosphereFog(FRHICommandListImmediate& RHICmdList)
{
	...
	FStylizedSkyPS::StyleParam SkyParam;
	SkyParam._HorizonLineContribution1_SkyNightGradient3 = FVector4(0.0f);
	...
	for (int32 ViewIndex = 0; ViewIndex < Views.Num(); ++ViewIndex)
	{
		...
		SetStylizedSkyShaders(RHICmdList, GraphicsPSOInit, View, SkyParam);
		// Draw a quad covering the view.
		RHICmdList.SetStreamSource(0, GScreenSpaceVertexBuffer.VertexBufferRHI, 0);
		RHICmdList.DrawIndexedPrimitive(GTwoTrianglesIndexBuffer.IndexBufferRHI, 0, 0, 4, 0, 2, 1);
	}
